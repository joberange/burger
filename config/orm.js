...
var orm = {
    ...
    updateOne: function (table, objColVals, condition, cb) {
        var queryString = 'UPDATE ?? SET ?? AS TRUE WHERE ?? = ??';
        ...
        connection.query(queryString, [table, devour, id, req.param.id], function (err, result) {
            if (err) throw err;
            cb(result);
        });
    }// CAN NOT FIGURE OUT PROPER QUERY FOR UPDATE ONE FUNCTION
};
